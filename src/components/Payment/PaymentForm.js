...
class PaymentForm extends Component {
  ...
  processPayment = async () => {
    ...
    await axios
      .post("/api/payment", { token, ...this.state })
      .then(() => {
    ...
    return (
      <div className="payment-form" onSubmit={this.handleSubmit}>
        <div className="payment-description">
          ...
          <p>
            Welcome tenants to process a payment fill the information to the
            right. If all the information is correct your payment will be
            processed and your landlord will be notified.
          </p>
        ...
        {this.state.isLoading ? (
          <div className="loader-container">
            ...
            <BeatLoader size={35} color={"#fff"} loading={this.state.loading} />
          </div>
          ...
          <div className="payment-container">
            ...
            <div className="payment-controls">
              <i onClick={this.printReceipt} className="fa fa-print" />
              <i onClick={this.closeReciept} className="fa fa-times" />
            </div>
          </div>
        ) : null}
        <div
          className={
            this.state.isLoading || this.state.displayTransactionReciept
              ? "hidden"
              : "form-data"
          }
        >
        ...
        {this.state.paymentError ? (
          <div className="payment-err">
            <h6>
              There was an issue processing your payment. Verify that you have
              entered a valid tentant name and SSN.
            </h6>
          </div>
        ) : null}
      </div>
