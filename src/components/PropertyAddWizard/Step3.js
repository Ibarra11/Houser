...
class Step3 extends Component {
  ...
  updateWizard(direction) {
    ...
    this.props.setTenantInformation(
      propertyTenantName,
      propertyTenantContactNumber,
      propertyTenantEmail,
      propertyTenantSSN
  ...
  render() {
    return (
      <div className="step3">
        ...
        <p>
          Fill out information if the propery is currently rented otherwise
          leave blank.
        </p>
        <div className="tenant-information">
          <div className="input-group">
            <h6>Name</h6>
            <input
              value={this.state.propertyTenantName}
              name="propertyTenantName"
          ...
          <div className="input-group">
            ...
            <input
              value={this.state.propertyTenantContactNumber}
              name="propertyTenantContactNumber"
              onChange={this.handleInputChange}
              type="tel"
            />
          </div>
          <div className="input-group">
            <h6>Email Address </h6>
            <input
              value={this.state.propertyTenantEmail}
              name="propertyTenantEmail"
              onChange={this.handleInputChange}
              type="email"
            />
          </div>
        ...
        <div className="wizard-controls">
          <button onClick={() => this.updateWizard("prev")}>
            Previous Step
          </button>
